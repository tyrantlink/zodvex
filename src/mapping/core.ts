...
function zodToConvexInternal<Z extends z.ZodTypeAny>(
  ...
  if (
    zodValidator instanceof z.ZodDefault ||
    zodValidator instanceof z.ZodPrefault
  ) {
    hasDefault = true;
  ...
  if (actualValidator instanceof z.ZodOptional) {
    ...
    if (
      actualValidator instanceof z.ZodDefault ||
      actualValidator instanceof z.ZodPrefault
    ) {
      hasDefault = true;
